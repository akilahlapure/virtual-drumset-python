...
while True:
    ...
    cv2.putText(frame, 'TOM HI', (70,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)
    cv2.rectangle(frame, (210, 580), (430, 700), (0,0,255), 1)
    cv2.putText(frame, 'TOM MID', (245,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 3, cv2.LINE_AA)
    cv2.rectangle(frame, (440, 580), (650, 700), (255,0,0), 1)
    cv2.putText(frame, 'TOM LOW', (445,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 3, cv2.LINE_AA)
    ...
    for cnt in contours:
        ...
        if x > 210 and y > 580 and x < 430 and y < 700:
            Press('w') #TOM MID
            break
        if x > 440 and y > 580 and x < 650 and y < 700:
            Press('e') #TOM LOW
            break
