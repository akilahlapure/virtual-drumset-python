...
hat = cv2.resize(cv2.imread('./images/hihat-nobg.png'),(200,100),interpolation=cv2.INTER_CUBIC)
snare = cv2.resize(cv2.imread('./images/snare-nobg.png'),(200,100),interpolation=cv2.INTER_CUBIC)
