...
snare = cv2.resize(cv2.imread('./images/snare.png'),(200,120),interpolation=cv2.INTER_CUBIC)
hihat = cv2.resize(cv2.imread('./images/ride-btm-cropped.png'),(220,440),interpolation=cv2.INTER_CUBIC)
tom = cv2.resize(cv2.imread('./images/tom.png'),(220,170),interpolation=cv2.INTER_CUBIC)
ride = cv2.flip(cv2.resize(cv2.imread('./images/ride-btm-cropped.png'),(220,440),interpolation=cv2.INTER_CUBIC), 1) #flip image horizontally

# Set the region area for detecting red color 
kick_center = [450,534] #[x, y]
...
snare_center = [710,500]
snare_thickness = [200,120]
